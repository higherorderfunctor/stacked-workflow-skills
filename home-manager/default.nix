...
#
# Integrates with programs.claude-code when available (home-manager >= 25.11),
# falls back to home.file for older versions or non-Claude tools.
#
# Usage:
...
#   services.stacked-workflow-skills.enable = true;
{
  ...
  hasClaude = lib.hasAttrByPath ["programs" "claude-code"] config;
in {
